...
function send_welcome_email(string $toEmail, string $fullName, string $role): void {
    ...
    $body = '<p>Hi ' . e($fullName) . ',</p>'
        . '<p>Welcome to Aike! Your ' . e($roleLabel) . ' account has been created successfully.</p>'
        . ($role === 'rider'
    ...
    mailer_dispatch($toEmail, $fullName, 'Welcome to Aike', mailer_layout('Welcome, ' . $fullName . '!', $body));
}
